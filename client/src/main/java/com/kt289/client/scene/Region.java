...
public class Region {
                ...
                while (true) {
                    if (flag1) {
                        ...
                        if (l2 > 0 && i3 > 0 && l2 < 103 && i3 < 103) {
                            GameObjectDefinition class8 = GameObjectDefinition.method199(l);
    ...
    public static boolean method173(int i, int j, int k) {
        try {
            ...
            GameObjectDefinition class8 = GameObjectDefinition.method199(i);
            if (j == 11) {
                j = 10;
            }
            if (j >= 5 && j <= 8) {
    ...
    public static void method174(int i, int j, int k, int l, int[][][] ai, int i1, int j1, CollisionMap class18,
        ...
        try {
            ...
            if (l == 5) {
                ...
                if (j5 > 0) {
                    l4 = GameObjectDefinition.method199(j5 >> 14 & 0x7fff).anInt231;
                }
                Object obj13;
                if (class8.anInt230 == -1 && class8.anIntArray250 == null) {
    ...
    private void method162(int i, int j, Scene class36, int k, int l, int i1, int j1, CollisionMap class18, int k1) {
        try {
            if (Region.aBoolean64) {
                ...
                if (method164(j1, j, 0, i1) != Region.anInt65) {
                    return;
                }
            }
            ...
            if (i == 5) {
                ...
                if (l4 > 0) {
                    j4 = GameObjectDefinition.method199(l4 >> 14 & 0x7fff).anInt231;
                }
                Object obj13;
                if (class8.anInt230 == -1 && class8.anIntArray250 == null) {
                ...
                for (int k6 = -5; k6 < anInt66 + 5; k6++) {
                    for (int l7 = 0; l7 < anInt67; l7++) {
                        ...
                        if (j9 >= 0 && j9 < anInt66) {
                            ...
                            if (k12 > 0) {
                                FloorDefinition class20 = FloorDefinition.aClass20Array430[k12 - 1];
                        ...
                        if (l12 >= 0 && l12 < anInt66) {
                            ...
                            if (l13 > 0) {
                                FloorDefinition class20_1 = FloorDefinition.aClass20Array430[l13 - 1];
                    ...
                    if (k6 >= 1 && k6 < anInt66 - 1) {
                        ...
                        for (int j17 = -5; j17 < anInt67 + 5; j17++) {
                            ...
                            if (j17 >= 1
                                    ...
                                    && method164(j17, k6, 0, k) == Region.anInt65)) {
                                ...
                                if (k18 > 0 || l18 > 0) {
                                    ...
                                    if (k > 0) {
                                        ...
                                        if (l18 > 0 && !FloorDefinition.aClass20Array430[l18 - 1].aBoolean435) {
                                            flag = false;
                                        }
                                    ...
                                    int l21 = 0;
                                    if (i21 != -1) {
                                        l21 = Rasterizer3D.anIntArray1439[Region.method170(j21, 96)];
                                    }
                                    if (l18 == 0) {
                                        ...
                                        FloorDefinition class20_2 = FloorDefinition.aClass20Array430[l18 - 1];
                                        int l22 = class20_2.anInt433;
                                        int i23;
                                        int j23;
                                        if (l22 >= 0) {
                                            j23 = Rasterizer3D.method424(0, l22);
                                            i23 = -1;
                                            ...
                                            j23 = Rasterizer3D.anIntArray1439[method171(class20_2.anInt441, 96)];
                                        }
