...
public class FloorDefinition {
    ...
    public static void method243(boolean flag, Archive class47) {
        try {
            ...
            for (int i = 0; i < FloorDefinition.anInt429; i++) {
                if (FloorDefinition.aClass20Array430[i] == null) {
                    FloorDefinition.aClass20Array430[i] = new FloorDefinition();
                }
                FloorDefinition.aClass20Array430[i].method244(false, class44_sub3_sub2);
            }
            if (!flag) {
