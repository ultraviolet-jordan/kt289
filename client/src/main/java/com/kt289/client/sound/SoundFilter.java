...
class SoundFilter {
    ...
    private float method152(int i, boolean flag, float f, int j) {
        try {
            ...
            SignLink.error("9156, " + i + ", " + flag + ", " + f + ", " + j + ", " + runtimeexception.toString());
        }
    ...
    private float method153(int i, float f) {
        try {
            ...
            SignLink.error("10683, " + i + ", " + f + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    private float method154(int i, int j, int k, float f) {
        try {
            ...
            SignLink.error("38617, " + i + ", " + j + ", " + k + ", " + f + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public int method155(int i, int j, float f) {
        try {
            ...
            SignLink.error("1468, " + i + ", " + j + ", " + f + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }

    public void method156(int i, SoundTrackEnvelope class1, Buffer class44_sub3_sub2) {
        try {
            if (i <= 0) {
                for (int j = 1; j > 0; j++) {
                }
            ...
            SignLink.error("9723, " + i + ", " + class1 + ", " + class44_sub3_sub2 + ", "
