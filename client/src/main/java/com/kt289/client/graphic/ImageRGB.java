...
public class ImageRGB extends Rasterizer {
    ...
    public ImageRGB(Archive class47, String s, int i) {
        aBoolean1442 = false;
        anInt1443 = 387;
        anInt1445 = 9;
        aByte1446 = 8;
        ...
        int[] ai = new int[j];
        for (int k = 0; k < j - 1; k++) {
            ai[k + 1] = class44_sub3_sub2_1.readUnsignedTriByte();
            if (ai[k + 1] == 0) {
                ai[k + 1] = 1;
            }
        }
    ...
    public void method435(byte byte0) {
        try {
            Rasterizer.method406(-78, anIntArray1448, anInt1449, anInt1450);
            if (byte0 == 5) {
                byte0 = 0;
                return;
            } else {
    ...
    public void method438(int i, int j, int k) {
        try {
            i += anInt1451;
            j += anInt1452;
            int l = i + j * Rasterizer.anInt1370;
            int i1 = 0;
            int j1 = anInt1450;
            int k1 = anInt1449;
            int l1 = Rasterizer.anInt1370 - k1;
            int i2 = 0;
            if (k != 8) {
            ...
            if (j < Rasterizer.anInt1372) {
                int k2 = Rasterizer.anInt1372 - j;
                j1 -= k2;
                j = Rasterizer.anInt1372;
                i1 += k2 * k1;
                l += k2 * Rasterizer.anInt1370;
            }
            if (j + j1 > Rasterizer.anInt1373) {
                j1 -= (j + j1) - Rasterizer.anInt1373;
            }
            ...
            if (i + k1 > Rasterizer.anInt1375) {
                int i3 = (i + k1) - Rasterizer.anInt1375;
                k1 -= i3;
                i2 += i3;
                l1 += i3;
            }
            if (k1 <= 0 || j1 <= 0) {
                ...
                method439(i1, Rasterizer.anIntArray1369, anIntArray1448, l, k1, j1, true, l1, i2);
                return;
            }
        } catch (RuntimeException runtimeexception) {
    ...
    public void method440(int i, byte byte0, int j) {
        try {
            j += anInt1451;
            i += anInt1452;
            int k = j + i * Rasterizer.anInt1370;
            int l = 0;
            int i1 = anInt1450;
            int j1 = anInt1449;
            ...
            if (i < Rasterizer.anInt1372) {
                int i2 = Rasterizer.anInt1372 - i;
                i1 -= i2;
                i = Rasterizer.anInt1372;
                l += i2 * j1;
                k += i2 * Rasterizer.anInt1370;
            }
            if (i + i1 > Rasterizer.anInt1373) {
                i1 -= (i + i1) - Rasterizer.anInt1373;
            }
            if (j < Rasterizer.anInt1374) {
                int j2 = Rasterizer.anInt1374 - j;
                j1 -= j2;
            ...
            if (j + j1 > Rasterizer.anInt1375) {
                int k2 = (j + j1) - Rasterizer.anInt1375;
                j1 -= k2;
                l1 += k2;
                k1 += k2;
            }
    ...
    public void method442(int i, int j, int k, int l) {
        try {
            ...
            j = 15 / j;
            k += anInt1452;
            int i1 = l + k * Rasterizer.anInt1370;
            int j1 = 0;
            int k1 = anInt1450;
            int l1 = anInt1449;
            int i2 = Rasterizer.anInt1370 - l1;
            int j2 = 0;
            if (k < Rasterizer.anInt1372) {
                ...
                j1 += k2 * l1;
                i1 += k2 * Rasterizer.anInt1370;
            }
            if (k + k1 > Rasterizer.anInt1373) {
                k1 -= (k + k1) - Rasterizer.anInt1373;
            }
            if (l < Rasterizer.anInt1374) {
                int l2 = Rasterizer.anInt1374 - l;
                l1 -= l2;
                l = Rasterizer.anInt1374;
                j1 += l2;
                i1 += l2;
                j2 += l2;
                i2 += l2;
            }
            if (l + l1 > Rasterizer.anInt1375) {
                int i3 = (l + l1) - Rasterizer.anInt1375;
                l1 -= i3;
                j2 += i3;
                i2 += i3;
            }
            if (l1 <= 0 || k1 <= 0) {
                ...
                method443(j1, i, i1, k1, Rasterizer.anIntArray1369, anIntArray1448, i2, j2, 0, l1, false);
                return;
            }
        } catch (RuntimeException runtimeexception) {
    ...
    public void method444(int[] ai, int i, int j, int k, int l, int i1, int[] ai1, int j1, int k1, int l1, int i2) {
        try {
            ...
            try {
                ...
                int l3 = i2 + i * Rasterizer.anInt1370;
                for (i = 0; i < i1; i++) {
                    int i4 = ai[i];
                    int j4 = l3 + i4;
                    int k4 = j3 + i3 * i4;
                    ...
                    for (i2 = -ai1[i]; i2 < 0; i2++) {
                        Rasterizer.anIntArray1369[j4++] = anIntArray1448[(k4 >> 16) + (l4 >> 16) * anInt1449];
                        k4 += i3;
                        l4 -= l2;
                    }
                    j3 += l2;
                    k3 += i3;
                    l3 += Rasterizer.anInt1370;
                }
                return;
            } catch (Exception _ex) {
                return;
    ...
    public void method445(int i, double d, int j, int k, int l, int i1, byte byte0, int j1, int k1) {
        try {
            ...
            try {
                ...
                int j3 = i1 + k1 * Rasterizer.anInt1370;
                for (k1 = 0; k1 < j1; k1++) {
                    int k3 = j3;
                    int l3 = l2;
                    int i4 = i3;
    ...
    public void method446(int i, IndexedImage class44_sub3_sub1_sub3, boolean flag, int j) {
        try {
            i += anInt1451;
            j += anInt1452;
            int k = i + j * Rasterizer.anInt1370;
            int l = 0;
            int i1 = anInt1450;
            int j1 = anInt1449;
            int k1 = Rasterizer.anInt1370 - j1;
            ...
            if (j < Rasterizer.anInt1372) {
                int i2 = Rasterizer.anInt1372 - j;
                i1 -= i2;
                j = Rasterizer.anInt1372;
                l += i2 * j1;
                k += i2 * Rasterizer.anInt1370;
            }
            if (j + i1 > Rasterizer.anInt1373) {
                i1 -= (j + i1) - Rasterizer.anInt1373;
            }
            if (i < Rasterizer.anInt1374) {
                int j2 = Rasterizer.anInt1374 - i;
                j1 -= j2;
                i = Rasterizer.anInt1374;
                l += j2;
                k += j2;
            ...
            if (i + j1 > Rasterizer.anInt1375) {
                int k2 = (i + j1) - Rasterizer.anInt1375;
                j1 -= k2;
                l1 += k2;
                k1 += k2;
            }
